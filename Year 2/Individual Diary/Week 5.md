...
- Each team have pitched their component diagrams, we picked the best one out of the three groups, and corrected some final errors. 
- We discussed how we would agree on names for common interfaces. 


**Result**
- A component diagram was agreed upon. 
- Each team agreed they would send the names of the methods they needed from other teams, these were then implemented in both teams class diagrams. 